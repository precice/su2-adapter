...
class CConfig {
 private:
  ...
  su2double* Obj_ChainRuleCoeff; /*!< \brief Array defining objective function for adjoint problem based on chain rule
                                    in terms of gradient w.r.t. density, velocity, pressure */
  ...
  unsigned short
      Unsteady_Simulation;         /*!< \brief Steady or unsteady (time stepping or dual time stepping) computation. */
  ...
  string *Marker_Euler,                /*!< \brief Euler wall markers. */
      ...
      *Marker_ActDiskInlet, *Marker_ActDiskOutlet, *Marker_Dirichlet, /*!< \brief Interface boundaries markers. */
  ...
  unsigned long Dyn_nIntIter; /*!< \brief Number of internal iterations (Newton-Raphson Method for nonlinear structural
                                 analysis). */
  ...
  unsigned short Kind_Solver,    /*!< \brief Kind of solver Euler, NS, Continuous adjoint, etc.  */
      ...
      Kind_FreeStreamOption,     /*!< \brief Kind of free stream option to choose if initializing with density or
                                    temperature  */
      ...
      *Kind_GridMovement,        /*!< \brief Kind of the unsteady mesh movement. */
      ...
      Kind_Linear_Solver_Prec_FSI_Struc, /*!< \brief Preconditioner of the linear solver for the structural part in FSI
                                            problems. */
      Kind_AdjTurb_Linear_Solver,        /*!< \brief Numerical solver for the turbulent adjoint implicit scheme. */
      Kind_AdjTurb_Linear_Prec,          /*!< \brief Preconditioner of the turbulent adjoint linear solver. */
      Kind_DiscAdj_Linear_Solver,        /*!< \brief Linear solver for the discrete adjoint system. */
      Kind_DiscAdj_Linear_Prec,          /*!< \brief Preconditioner of the discrete adjoint linear solver. */
      Kind_DiscAdj_Linear_Solver_FSI_Struc, /*!< \brief Linear solver for the discrete adjoint system in the structural
                                               side of FSI problems. */
      Kind_DiscAdj_Linear_Prec_FSI_Struc,   /*!< \brief Preconditioner of the discrete adjoint linear solver in the
                                               structural side of FSI problems. */
  ...
  unsigned short Kind_Material_Compress, /*!< \brief Determines if the material is compressible or incompressible
                                            (structural analysis). */
      Kind_Material,                     /*!< \brief Determines the material model to be used (structural analysis). */
      Kind_Struct_Solver, /*!< \brief Determines the geometric condition (small or large deformations) for structural
                             analysis. */
      Kind_DV_FEA;        /*!< \brief Kind of Design Variable for FEA problems.*/
  unsigned short Kind_Turb_Model;  /*!< \brief Turbulent model definition. */
  unsigned short Kind_Trans_Model, /*!< \brief Transition model definition. */
      Kind_ActDisk, Kind_Engine_Inflow, Kind_Inlet, *Kind_Data_Riemann,
      *Kind_Data_Giles;                    /*!< \brief Kind of inlet boundary treatment. */
  su2double Linear_Solver_Error;           /*!< \brief Min error of the linear solver for the implicit formulation. */
  su2double Deform_Linear_Solver_Error;    /*!< \brief Min error of the linear solver for the implicit formulation. */
  su2double Linear_Solver_Error_FSI_Struc; /*!< \brief Min error of the linear solver for the implicit formulation in
                                              the structural side for FSI problems . */
  unsigned long Linear_Solver_Iter; /*!< \brief Max iterations of the linear solver for the implicit formulation. */
  unsigned long
      Deform_Linear_Solver_Iter; /*!< \brief Max iterations of the linear solver for the implicit formulation. */
  unsigned long Linear_Solver_Iter_FSI_Struc; /*!< \brief Max iterations of the linear solver for FSI applications and
                                                 structural solver. */
  ...
  su2double Kappa_1st_AdjFlow,      /*!< \brief JST 1st order dissipation coefficient for adjoint flow equations (coarse
                                       multigrid levels). */
  ...
  su2double Deform_ElasticityMod,
      Deform_PoissonRatio;    /*!< young's modulus and poisson ratio for volume deformation stiffness model */
  ...
  bool Update_HTPIncidence;        /*!< \brief Boolean flag for whether to update the AoA for fixed lift mode on a given
                                      iteration. */
  ...
  unsigned short
      Analytical_Surface; /*!< \brief Information about the analytical definition of the surface for grid adaptation. */
  ...
  su2double RefArea,                  /*!< \brief Reference area for coefficient computation. */
      ...
      *CFL, *HTP_Axis,                /*!< \brief Location of the HTP axis. */
  ...
  su2double Gamma,                    /*!< \brief Ratio of specific heats of the gas. */
      ...
      *Velocity_FreeStream,     /*!< \brief Free-stream velocity vector of the fluid.  */
      ...
      TurbulenceIntensity_FreeStream, /*!< \brief Freestream turbulent intensity (for sagt transition model) of the
                                         fluid.  */
  ...
  unsigned long precice_loadRampingDuration; /*!< \brief Number of physical time steps for which the load ramping
  ...
  void addEnumOption(const string name, unsigned short& option_field, const map<string, Tenum>& enum_map,
                     Tenum default_value) {
    assert(option_map.find(name) == option_map.end());
    all_options.insert(pair<string, bool>(name, true));
  ...
  void addConvectOption(const string name, unsigned short& space_field, unsigned short& centered_field,
  ...
  void addPeriodicOption(const string& name, unsigned short& nMarker_PerBound, string*& Marker_PerBound,
    ...
    assert(option_map.find(name) == option_map.end());
    all_options.insert(pair<string, bool>(name, true));
    COptionBase* val = new COptionPeriodic(name, nMarker_PerBound, Marker_PerBound, Marker_PerDonor, RotCenter,
 ...
 public:
   ...
   */
  CConfig(char case_filename[MAX_STRING_SIZE], unsigned short val_software, unsigned short val_iZone,
   ...
   * \return Flag for whether binary SU2 native restart files are written, if <code>TRUE</code> then the code will
   * output binary restart files.
   */
   ...
   * \param[in] val_smoothnumgrid - <code>TRUE</code> if there is smoothing of the grid coordinates; otherwise
   * <code>FALSE</code>.
   */
   ...
   */
  void SetSpline(vector<su2double>& x, vector<su2double>& y, unsigned long n, su2double yp1, su2double ypn,
                 vector<su2double>& y2);
   ...
   */
  su2double GetSpline(vector<su2double>& xa, vector<su2double>& ya, vector<su2double>& y2a, unsigned long n,
                      su2double x);
   ...
   * \return Number of corresponding time steps for which the force vector is continuously increased up to the original
   * value
   */
